...
.cinematic-footer-wrapper {
  ...
  --pill-bg-1: color-mix(in oklch, var(--color-DarkLava) 50%, transparent);
  --pill-bg-2: color-mix(in oklch, var(--color-DarkLava) 30%, transparent);
  --pill-shadow: color-mix(in oklch, var(--color-DarkLava) 50%, transparent);
  --pill-highlight: color-mix(in oklch, #fff 10%, transparent);
  --pill-inset-shadow: color-mix(in oklch, #000 80%, transparent);
  --pill-border: color-mix(in oklch, #fff 8%, transparent);
  
  --pill-bg-1-hover: color-mix(in oklch, var(--color-DarkLava) 70%, transparent);
  --pill-bg-2-hover: color-mix(in oklch, var(--color-DarkLava) 40%, transparent);
  --pill-border-hover: color-mix(in oklch, #fff 20%, transparent);
  --pill-shadow-hover: color-mix(in oklch, #000 70%, transparent);
  --pill-highlight-hover: color-mix(in oklch, #fff 20%, transparent);
}
...
.footer-aurora {
  background: radial-gradient(
    circle at 50% 50%, 
    rgba(229, 229, 224, 0.15) 0%, 
    rgba(139, 139, 115, 0.15) 40%, 
    transparent 70%
  );
}
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Just Imagine, I Code</span> <span className="text-white/60">✦</span>
    <span>You Dream It, I Code It</span> <span className="text-white/60">✦</span>
    <span>Just Imagine, I Code</span> <span className="text-white/60">✦</span>
    <span>You Dream It, I Code It</span> <span className="text-white/60">✦</span>
    <span>Just Imagine, I Code</span> <span className="text-white/60">✦</span>
  </div>
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-white/50 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Zenux. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">Arkeno</span>
            </div>
